...
describe('GET /api/products/getproducts/:id', () => {
    let mongo;
    ...
    it('returns 400 for invalid object id', async () => {
        const res = await request(app).get('/api/products/getproducts/not-a-valid-id');
    ...
    it('returns 404 when product not found', async () => {
        ...
        const res = await request(app).get(`/api/products/getproducts/${id}`);
    ...
    it('returns product when found', async () => {
        ...
        const res = await request(app).get(`/api/products/getproducts/${product._id}`);
